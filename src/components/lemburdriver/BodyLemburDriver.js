...
export default class BodyLembur extends Component {
    ...
    renderRow(library) {
        return (
            <ItemLemburDriver library={library} />
        )
    }
