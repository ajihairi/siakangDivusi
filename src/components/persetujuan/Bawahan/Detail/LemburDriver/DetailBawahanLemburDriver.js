...
import ItemDetailBawahanLemburDriver from './ItemDetailBawahanLemburDriver';

var ds = new ListView.DataSource({rowHasChanged: (r1, r2) => r1 !== r2});

export default class DetailBawahanLemburDriver extends Component {
    ...
    renderRow(library) {
        return (
          	    <ItemDetailBawahanLemburDriver library={library} /> 
        )
    }
