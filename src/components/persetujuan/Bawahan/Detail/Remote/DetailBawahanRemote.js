...
import ItemDetailBawahanRemote from './ItemDetailBawahanRemote';

var ds = new ListView.DataSource({rowHasChanged: (r1, r2) => r1 !== r2});

export default class DetailBawahanRemote extends Component {
    ...
    renderRow(library) {
        return (
          	    <ItemDetailBawahanRemote library={library} /> 
        )
    }
