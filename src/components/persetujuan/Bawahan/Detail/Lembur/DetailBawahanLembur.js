...
import ItemDetailBawahanLembur from './ItemDetailBawahanLembur';

var ds = new ListView.DataSource({rowHasChanged: (r1, r2) => r1 !== r2});

export default class DetailBawahanLembur extends Component {
    ...
    renderRow(library) {
        return (
          	    <ItemDetailBawahanLembur library={library} /> 
        )
    }
