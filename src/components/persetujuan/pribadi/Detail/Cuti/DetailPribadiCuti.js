...
import ItemDetailPribadiCuti from './ItemDetailPribadiCuti';

var ds = new ListView.DataSource({rowHasChanged: (r1, r2) => r1 !== r2});

export default class DetailPribadiCuti extends Component {
    ...
    renderRow(library) {
        return (
          	    <ItemDetailPribadiCuti library={library} /> 
        )
    }
